<?php
  $faq = [
    ...
    [
      ...
      'answer' => 'Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.'
    ],
    [
...
<body>
  ...
  <header>
    ...
    <nav>
      ...
      <div class="menu-top">
        <ul>
          <li><a href="#"><img src="https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo-650x366.png" alt="logo"></a></li>
